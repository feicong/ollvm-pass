...
bool AntiClassDump::doInitialization(Module &M) {
  // Basic Defs
...
bool AntiClassDump::runOnModule(Module &M) {
...
AntiClassDump::splitclass_ro_t(ConstantStruct *class_ro, Module *M) {
  // Split a class_ro_t structure
...
void AntiClassDump::handleClass(GlobalVariable *GV, Module *M) {
...
void AntiClassDump::HandleMethods(ConstantStruct *class_ro, IRBuilder<> *IRB, Module *M,
...
GlobalVariable *AntiClassDump::readPtrauth(GlobalVariable *GV) {
