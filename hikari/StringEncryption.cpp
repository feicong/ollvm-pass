...
bool StringEncryption::initialize(Module &M) {
...
bool StringEncryption::handleableGV(GlobalVariable *GV) {
...
bool StringEncryption::runOnFunction(Function &F) {
...
void
StringEncryption::processConstantAggregate(GlobalVariable *strGV, ConstantAggregate *CA,
...
void StringEncryption::HandleUser(User *U, SmallVector<GlobalVariable *, 32> &Globals,
                std::set<User *> &Users,
...
void StringEncryption::HandleFunction(Function *Func) {
...
GlobalVariable *StringEncryption::ObjectiveCString(GlobalVariable *GV, std::string name,
...
void StringEncryption::HandleDecryptionBlock(
