...
bool AntiHook::initialize(Module &M) {
...
void AntiHook::HandleInlineHookAArch64(Function *F) {
...
void AntiHook::HandleObjcRuntimeHook(Function *ObjcMethodImp, std::string classname,
...
void AntiHook::CreateCallbackAndJumpBack(IRBuilder<> *IRBB, BasicBlock *C) {
