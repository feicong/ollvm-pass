...
#else
  FCmpInst * condition = new FCmpInst(FCmpInst::FCMP_TRUE, LHS, RHS, *var4);
  condition->insertInto(basicBlock, basicBlock->end());
#endif
...
#else
  FCmpInst * condition2 = new FCmpInst(CmpInst::FCMP_TRUE, LHS, RHS, *var6);
  condition2->insertInto(originalBB, originalBB->end());
#endif
